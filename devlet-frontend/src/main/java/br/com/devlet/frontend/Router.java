...
/**
* Router allows to manage scenes switching on JavaFX Application with an easy API
...
public final class Router {
   ...
   // Router Main Class reference to get main package
   private static Object mainRef;
   // Router Application Stage reference to set scenes
   ...
   /**
    * Router Inner Class used into routes map
    */
   ...
   /**
    * Router constructor kept private to apply Singleton pattern
    */
   private Router() {}
   ...
   /** Router binder with Application Stage and main package
   ...
   /** set Router references only if they are not set yet
    * @param ref: Main Class reference
    * @param win: Application Stage
    */
   ...
   /** Switch between Router route and show corresponding scenes
    * @param routeLabel: Route label identifier
   ...
   private static void loadNewRoute(RouteScene route) throws IOException {
       ...
       // set Router current route reference
       currentRoute = route;
   ...
   /* Syntactic sugar for goTo() method when Router get set */
   ...
   /** set Router switching animation
